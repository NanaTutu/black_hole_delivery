                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Text("Menu", style: GoogleFonts.poppins(
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text("\$8.50", style: GoogleFonts.poppins(
                                                        fontSize: 22,
                                                        fontWeight: FontWeight.w500,
                                                        color: const Color.fromRGBO(24, 23, 43, 1)
                                                    ),)
                                        ...
                                        child: Row(
                                          children: [
                                            Container(
                                              ...
                                              child: const Image(
                                                image: AssetImage("assets/images/ConradImages/conradTomato.png"),
                                                fit: BoxFit.fill,
                                              ),
                                            ),
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                                  children: [
                                                    Text("Tomato", style: GoogleFonts.poppins(
                                                        fontSize: 22,
                                                        fontWeight: FontWeight.w500,
                                                        color: const Color.fromRGBO(24, 23, 43, 1)
                                                    ),),
